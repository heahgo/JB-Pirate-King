...
public:
    ...
    wxBitmap    m_bm_ais_ids_pi;
    wxBitmap    m_bm_ais_ids_toggled_pi;
    wxBitmap    m_bm_ais_ids_grey_pi;

    wxString    m_s_ais_ids_pi;
    wxString    m_s_ais_ids_toggled_pi;
    wxString    m_s_ais_ids_grey_pi;
...
#endif
    wxBitmap    m_bm_day_ais_ids_pi;
    wxBitmap    m_bm_day_ais_ids_toggled_pi;
    wxBitmap    m_bm_day_ais_ids_grey_pi;

    wxBitmap    m_bm_dusk_ais_ids_pi;
    wxBitmap    m_bm_dusk_ais_ids_toggled_pi;
    wxBitmap    m_bm_dusk_ais_ids_grey_pi;

    wxBitmap    m_bm_night_ais_ids_pi;
    wxBitmap    m_bm_night_ais_ids_toggled_pi;
    wxBitmap    m_bm_night_ais_ids_grey_pi;
